...
```
https://drive.google.com/file/d/1IX1qGSbH3QsB540JFhyHLjqxQx1oXMhj/view?usp=sharing
```
...
# number of seconds per day = sec_per_day
```
...
* No you can't add a number and character.
...
* Yes because FALSE also mean 0 so the vector would be numerical and you can add to a number.
...
```{r}
qplot(x = x_axis, y = y_axis) + labs( title = "my amazing plot of x_axis versus y_axis", x = "My x axis", y = "my y axis",)
